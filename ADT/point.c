...
{
    return(((Absis(P1))==(Absis(P1))&&((Ordinat(P1))==(Ordinat(P2)))));
}
...
{
    float deg;
    float copyabs = Absis(*P);
    #define M_PI 3.14159265358979323846
    deg = Sudut * M_PI/180;
    Absis(*P) = (cos(deg)*copyabs) - (sin(deg)*Ordinat(*P));
    Ordinat(*P) = -(sin(deg)*copyabs) + (cos(deg)*Ordinat(*P));
}
